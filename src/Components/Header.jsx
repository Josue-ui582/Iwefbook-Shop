...
const Header = () => {
    return(
        <header className="w-full h-7xl flex justify-center header items-center bg-slate-300">
            <div className="w-full">
                <h1 className="lg:text-7xl md:text-5xl text-3xl text-center">Bienvenu sur <span className="titre">Iwefebooks</span></h1>
