            ...
            <div>
                ...
                <div className="flex gap-4 mt-6 overflow-hidden">
                    <a href="mailto:hounhouijosue1@gmail.com">
                        <div className="flex items-center gap-4 p-4 email rounded hover:shadow-md overflow-hidden">
                    ...
                    <a href="#">
                        <div className="flex items-center gap-4 p-4 email rounded hover:shadow-md overflow-hiddeb">
